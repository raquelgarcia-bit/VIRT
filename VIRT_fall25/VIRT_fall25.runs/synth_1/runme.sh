...
HD_PWD='/home/raquel/vivado_projects/VIRT_fall25/VIRT_fall25.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ov7670.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ov7670.tcl
