...
HD_PWD='/home/raquel/vivado_projects/VIRT_fall25/VIRT_fall25.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ov7670.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_ov7670.tcl -notrace
