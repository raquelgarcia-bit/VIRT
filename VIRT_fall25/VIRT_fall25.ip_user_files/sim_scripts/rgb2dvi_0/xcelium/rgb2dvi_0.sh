...
#
# Script generated by Vivado on Fri Nov 21 06:32:13 CST 2025
...
# script info
echo -e "rgb2dvi_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.rgb2dvi_0
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/raquel/vivado_projects/VIRT_fall25/VIRT_fall25.cache/compile_simlib/xcelium"
  fi
