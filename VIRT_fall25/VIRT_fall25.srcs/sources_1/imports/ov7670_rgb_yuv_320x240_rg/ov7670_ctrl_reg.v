...
module ov7670_ctrl_reg
  ...
  wire        mode_change;
    ...
    //TODO rgb 565 migration
  reg [15:0] reg_yuv422, reg_yuv422_test, reg_rgb565, reg_rgb565_test;
  ...
  // lsb 8 bits are the register value to be written
    ...
    //TODO rgb565 migration
  always @ (*) begin
    // *IG means Implementation guide
    case (cnt_reg)
      6'h00:
        reg_rgb565_test = 16'h1280;
      ...
      6'h03:
        reg_rgb565_test = 16'h0901; 
               ...
               //   11: 4x
      6'h04:
        reg_rgb565_test = 16'h40E0;
               // 40: COM15 Full 0-255 output, RGB 565
               // [7:6]="11": Full output range
               // [5:4]="10": RGB 565
               // [3:0]=0: Reserved
      6'h05:
        reg_rgb565_test = 16'h8C02;
               // 8C: RGB444
               // [7:2]=0: Reserved
               // [1]=1: Enable RGB444
      ...
      6'h07:
        //reg_rgb565_test = 16'h0F43; // 0F: COM6 Common Control 6
        reg_rgb565_test = 16'h0F4B;
     ...
     //x"581E", --x"589e", -- MTXS  - Matrix sign and auto contrast
      ...
      6'h0A:
        reg_rgb565_test = 16'h4FB3; // MTX1  - colour conversion matrix
      6'h0B:
        reg_rgb565_test = 16'h50B3; // MTX2  - colour conversion matrix
      6'h0C:
        reg_rgb565_test = 16'h5100; // MTX3  - colour conversion matrix
      6'h0D:
        reg_rgb565_test = 16'h523D; // MTX4  - colour conversion matrix
      6'h0E:
        reg_rgb565_test = 16'h53A7; // MTX5  - colour conversion matrix
      6'h0F:
        reg_rgb565_test = 16'h54E4; // MTX6  - colour conversion matrix
      6'h10:
        reg_rgb565_test = 16'h589E; // MTXS  - Matrix sign and auto contrast

      6'h11:
        reg_rgb565_test = 16'h3DC0; // COM13: default 88
    ...
    // Trial and error
      6'h12:
        reg_rgb565_test = 16'hB084; // recommended TFG (reserved)
    // hamster
      6'h13:
        reg_rgb565_test = 16'h0E61; // COM5 reserved: default 01
      6'h14:
        reg_rgb565_test = 16'h1602; // reserved
      6'h15:
        reg_rgb565_test = 16'h2102; // ADCCTR0 (reserved): default 02 
      6'h16:
        reg_rgb565_test = 16'h2291; // ADCCTR1 (reserved): default 01 
      6'h17:
        reg_rgb565_test = 16'h2907; // RSVD (reserved): default XX 
      6'h18:
        reg_rgb565_test = 16'h330B; // CHLF Array Current Control (reserved):
                                     // default 08 
      6'h19:
        reg_rgb565_test = 16'h350B; // RSVD (reserved): default XX
      6'h1A:
        reg_rgb565_test = 16'h371D; // ADC (reserved): default 3F
      6'h1B:
        reg_rgb565_test = 16'h3871; // ACOM (reserved): default 01.
                                     // ADC and Analog Common Mode Control
      6'h1C:
        reg_rgb565_test = 16'h392A; // OFON (reserved): default 00.
                                     // ADC Offset Control 

      6'h1D:
        reg_rgb565_test = 16'h3C78; // COM12 (default 69)
             // [7]= 0: No HREF when VSYNC is low
             // [6:0]: Reserved
      6'h1E:
        reg_rgb565_test = 16'h4D40; // RSVD (reserved): default XX
      6'h1F:
        reg_rgb565_test = 16'h4E20; // RSVD (reserved): default XX
      6'h20:
        reg_rgb565_test = 16'h7410; // REG74 default 00
             // [4]=1 : Digital Gain control by REG74[1:0]
             // [1:0]=00: Bypass
      6'h21:
        reg_rgb565_test = 16'h8D4F; // RSVD (reserved): default XX
      6'h22:
        reg_rgb565_test = 16'h8E00; // RSVD (reserved): default XX
      6'h23:
        reg_rgb565_test = 16'h8F00; // RSVD (reserved): default XX
      6'h24:
        reg_rgb565_test = 16'h9000; // RSVD (reserved): default XX
      6'h25:
        reg_rgb565_test = 16'h9100; // RSVD (reserved): default XX
      6'h26:
        reg_rgb565_test = 16'h9600; // RSVD (reserved): default XX
      6'h27:
        reg_rgb565_test = 16'h9A00; // RSVD (reserved): default XX
      6'h28:
        reg_rgb565_test = 16'hB10C; // ABLC1: default 00.
             // Automatic Black Level Calibration
             // [3]=1 : Reserved (hamster=1)
             // [2]=1 : Enable ABLC
      6'h29:
        reg_rgb565_test = 16'hB20E; // RSVD (reserved): default XX
      6'h2A:
        reg_rgb565_test = 16'hB382; // THL_ST: ABLC Target: default 80
             // Lower limit of black leve +0x80
      6'h2B:
        reg_rgb565_test = 16'hB80A; // RSVD (reserved): default XX


      // ---------

      6'h2C:
        reg_rgb565_test = 16'h1520; // 15: COM10 Common Control 10
                             // [7]=0: Reserved
                             // [6]=0: Use HREF not HSYNC
                             // [5]=1: PCLK doesnt toggle during horizontl blank
                             // others default
      6'h2D:
        reg_rgb565_test = 16'h1711; // HSTART HREF start high 8-bit.
              // The first pixels flicker
              // 1700; // HSTART HREF start high 8-bit.
              // For windowing. Dont want to do
      6'h2E:
        reg_rgb565_test = 16'h1800; // HSTOP HREF end high 8-bit.
             // For windowing. Dont want to do
      6'h2F:
        reg_rgb565_test = 16'h1900; // VSTRT VREF start high 8-bit.
             // For windowing. Dont want to do
      6'h30:
        reg_rgb565_test = 16'h1A00; // VSTOP VREF end high 8-bit.
             // For windowing. Dont want to do
      6'h31:
        reg_rgb565_test = 16'h3200; // HREF Control
      ...
      // -- QVGA 320x240
      6'h32:
        reg_rgb565_test = 16'h0C04; // 0C: COM3 Common Control 3
                             // [3]=1: Enable scale (for QQVGA/2)
                             // [2]=0: Disable DCW
                             // others default
      6'h33:
        reg_rgb565_test = 16'h3E19; // 3E: COM14 Common Control 14
      ...
      6'h34:
        reg_rgb565_test = 16'h703A; // 70: SCALING_XSC
      ...
      6'h35:
        reg_rgb565_test = 16'h71B5; // 71: SCALING_YSC
      ...
      6'h36:
        reg_rgb565_test = 16'h7211; // 72: SCALING_DCWCTR DCW Control
      ...
      6'h37:
        reg_rgb565_test = 16'h73F1; // 73: SCALING_PCLK_DIV
                             // [7:4]=F: Reserved, and manual says default is 0
                             //          but IG says F
                             // [3]=0: Enable clk divider for DSP scale control
                             // [2:0]=001: Divided by 2 -> QVGA
      6'h38:
        reg_rgb565_test = 16'hA202; // A2: SCALING_PCLK_DELAY Pixel Clock Delay
                             // [7]: Reserved
                             // [6:0]=02: Default scaling ouput delay
      //  end QQVGA
      6'h39:
        reg_rgb565_test = 16'hFFFF;  // FINISH CONDITION, register FF doesnt exist
      default:
        reg_rgb565_test = 16'hFFFF;  // FINISH CONDITION
    endcase
  end
...
//  Memory without clock
  ...
  begin
    case(cnt_reg)
      8'h0: reg_rgb565 = 16'h1280;
            // 12:COM7
            // [7]=1: Reset all registers to default values
      8'h1: reg_rgb565 = 16'h1180;
      ...
      8'h2: reg_rgb565 = 16'h6B0A;
            // DBLV  default 0A
            // [7:6] = 00 : Bypass PLL
            // [5]: reserved
            // [4] = 0 : Enable internal regulator
            // [3:0]: reserved 
      8'h3: reg_rgb565 = 16'h1204;
            // 12:COM7
            // [2,0]="10": Output format RGB 
      8'h4: reg_rgb565 = 16'h0901;
            // 09:COM2 Common Control 2. Default: 01
            // [7:5] : Reserved
            // [4]   : Soft sleep mode
            // [3:2] : Reserved
            ...
            //   10: 3x
            //   11: 4x
      8'h5: reg_rgb565 = 16'h40E0;
            // 40:COM15  Full 0-255 output, RGB 565
            // [7:6] = 11: Full output range
            // [5:4] = 10: RGB565
            // [3:0] = 0:  Reserved
      8'h6: reg_rgb565 = 16'h8C00;
      ...
      8'h2A: reg_rgb565 = 16'h0E61;
            // COM5. Default XX (reserved)
      8'h2B: reg_rgb565 = 16'h0F4B;
            ...
            // [3] = 1 (reserved) 
            // [0] = 1 (reserved) 
      8'h2C: reg_rgb565 = 16'h1602;
            // reserved
      8'h2D: reg_rgb565 = 16'h1E37;
            ...
            // [1:0] : Reserved (01) - > 11
      8'h2E: reg_rgb565 = 16'h2102;
            // ADCCTR0 (reserved): default 02 
      8'h2F: reg_rgb565 = 16'h2291;
            // ADCCTR1 (reserved): default 01 
      8'h30: reg_rgb565 = 16'h2907;
            // RSVD (reserved): default XX 
      8'h31: reg_rgb565 = 16'h330B;
            // CHLF Array Current Control (reserved): default 08 
      8'h32: reg_rgb565 = 16'h350B;
            // RSVD (reserved): default XX
      8'h33: reg_rgb565 = 16'h371D;
            // ADC (reserved): default 3F
      8'h34: reg_rgb565 = 16'h3871;
            // ACOM (reserved): default 01. ADC and Analog Common Mode Control
      8'h35: reg_rgb565 = 16'h392A;
            // OFON (reserved): default 00. ADC Offset Control 
      8'h36: reg_rgb565 = 16'h3C78;
            // COM12 (default 69)
            // [7]= 0: No HREF when VSYNC is low
            // [6:0]: Reserved
      8'h37: reg_rgb565 = 16'h4D40;
            // RSVD (reserved): default XX
      8'h38: reg_rgb565 = 16'h4E20;
            // RSVD (reserved): default XX
      8'h39: reg_rgb565 = 16'h6900;
            // Fix Gain Control
      ...
      8'h3A: reg_rgb565 = 16'h7410;
            // REG74 default 00
            // [4]=1 : Digital Gain control by REG74[1:0]
            // [1:0]=00: Bypass
      8'h3B: reg_rgb565 = 16'h8D4F;
            // RSVD (reserved): default XX
      8'h3C: reg_rgb565 = 16'h8E00;
            // RSVD (reserved): default XX
      8'h3D: reg_rgb565 = 16'h8F00;
            // RSVD (reserved): default XX
      8'h3E: reg_rgb565 = 16'h9000;
            // RSVD (reserved): default XX
      8'h3F: reg_rgb565 = 16'h9100;
            // RSVD (reserved): default XX
      8'h40: reg_rgb565 = 16'h9600;
            // RSVD (reserved): default XX
      8'h41: reg_rgb565 = 16'h9A00;
            // RSVD (reserved): default XX
      8'h42: reg_rgb565 = 16'hB084;
            // recommended TFG (reserved)
      8'h43: reg_rgb565 = 16'hB10C;
            // ABLC1: default 00. Automatic Black Level Calibration
            // [3]=1 : Reserved -> 1
            // [2]=1 : Enable ABLC
      8'h44: reg_rgb565 = 16'hB20E;
            // RSVD (reserved): default XX
      8'h45: reg_rgb565 = 16'hB382;
            // THL_ST: ABLC Target: default 80
            // Lower limit of black leve +0x80
      8'h46: reg_rgb565 = 16'hB80A;
            // RSVD (reserved): default XX
      8'h47: reg_rgb565 = 16'h430A;
            // AWBC1 (reserved): default 14
      8'h48: reg_rgb565 = 16'h44F0;
            // AWBC2 (reserved): default F0 <-
      8'h49: reg_rgb565 = 16'h4534;
            // AWBC3 (reserved): default 45
      8'h4A: reg_rgb565 = 16'h4658;
            // AWBC4 (reserved): default 61
      8'h4B: reg_rgb565 = 16'h4728;
            // AWBC5 (reserved): default 51
      8'h4C: reg_rgb565 = 16'h483A;
            // AWBC6 (reserved): default 79
      8'h4D: reg_rgb565 = 16'h5988;
            // AWB Control (reserved): default XX
      8'h4E: reg_rgb565 = 16'h5A88;
            // AWB Control (reserved): default XX
      8'h4F: reg_rgb565 = 16'h5B44;
            // AWB Control (reserved): default XX
      8'h50: reg_rgb565 = 16'h5C67;
            // AWB Control (reserved): default XX
      8'h51: reg_rgb565 = 16'h5D49;
            // AWB Control (reserved): default XX
      8'h52: reg_rgb565 = 16'h5E0E;
            // AWB Control (reserved): default XX
      8'h53: reg_rgb565 = 16'h6C0A;
            // AWBCTR3. AWB Control 3: default 02
      8'h54: reg_rgb565 = 16'h6D55;
            // AWBCTR2. AWB Control 2: default 55
      8'h55: reg_rgb565 = 16'h6E11;
            // AWBCTR1. AWB Control 1: default C0
      8'h56: reg_rgb565 = 16'h6F9F;
            // AWBCTR0. AWB Control 0: default 9A
            // 9E for advance AWB
      8'h57: reg_rgb565 = 16'h6A40;
            // GGAIN. G Channel AWB Gain. default 00
      8'h58: reg_rgb565 = 16'h0140;
            // AWB Blue channel gain setting. default 80. Range 00-FF
      8'h59: reg_rgb565 = 16'h0260;
            // AWB Red  channel gain setting. default 80. Range 00-FF
            // COM8 Again, turn on AGC and AEC and AWB
      8'h5A: reg_rgb565 = 16'h13E7;
            // COM8. Default  8F (1000 1111)
      ...
      8'h6B: reg_rgb565 = 16'h4138;
            ...
            //    = 0: original, =1: double
            // [0]: Reserved
      8'h6C: reg_rgb565 = 16'h5640;
            // Contrast Control. default 40
      8'h6D: reg_rgb565 = 16'h3411;
            // ARBLM. Array Reference Control. default 11 <-
      8'h6E: reg_rgb565 = 16'h3B12;
            // COM11. default 00
      ...
      8'h70: reg_rgb565 = 16'h9600;
            // RSVD (reserved): default XX -- Again
      8'h71: reg_rgb565 = 16'h9730;
            // RSVD (reserved): default XX
      8'h72: reg_rgb565 = 16'h9820;
            // RSVD (reserved): default XX
      8'h73: reg_rgb565 = 16'h9930;
            // RSVD (reserved): default XX
      8'h74: reg_rgb565 = 16'h9A84;
            // RSVD (reserved): default XX
      8'h75: reg_rgb565 = 16'h9B29;
            // RSVD (reserved): default XX
      8'h76: reg_rgb565 = 16'h9C03;
            // RSVD (reserved): default XX
      8'h77: reg_rgb565 = 16'h9D4C;
            // BD50ST: 50Hz banding filter value. default 99
            // efective only when COM8[5]=1 and COM11[3]=1
      8'h78: reg_rgb565 = 16'h9E3F;
            // BD60ST: 60Hz banding filter value. default 7F
            // efective only when COM8[5]=1 and COM11[3]=0
      8'h79: reg_rgb565 = 16'h7804;
            // RSVD (reserved): default XX
            // extra weird stuff, some sort of multiplexor register
      8'h7A: reg_rgb565 = 16'h7901;
            // RSVD (reserved): default XX
      8'h7B: reg_rgb565 = 16'hC8F0;
            // RSVD (reserved): default XX
      8'h7C: reg_rgb565 = 16'h790F;
            // RSVD (reserved): default XX
      8'h7D: reg_rgb565 = 16'hC8F0;
            // RSVD (reserved): default XX
      8'h7E: reg_rgb565 = 16'h7910;
            // RSVD (reserved): default XX
      8'h7F: reg_rgb565 = 16'hC87E;
            // RSVD (reserved): default XX
      8'h80: reg_rgb565 = 16'h790A;
            // RSVD (reserved): default XX
      8'h81: reg_rgb565 = 16'hC880;
            // RSVD (reserved): default XX
      8'h82: reg_rgb565 = 16'h790B;
            // RSVD (reserved): default XX
      8'h83: reg_rgb565 = 16'hC801;
            // RSVD (reserved): default XX
      8'h84: reg_rgb565 = 16'h790C;
            // RSVD (reserved): default XX
      8'h85: reg_rgb565 = 16'hC80F;
            // RSVD (reserved): default XX
      8'h86: reg_rgb565 = 16'h790D;
            // RSVD (reserved): default XX
      8'h87: reg_rgb565 = 16'hC820;
            // RSVD (reserved): default XX
      8'h88: reg_rgb565 = 16'h7909;
            // RSVD (reserved): default XX
      8'h89: reg_rgb565 = 16'hC880;
            // RSVD (reserved): default XX
      8'h8A: reg_rgb565 = 16'h7902;
            // RSVD (reserved): default XX
      8'h8B: reg_rgb565 = 16'hC8C0;
            // RSVD (reserved): default XX
      8'h8C: reg_rgb565 = 16'h7903;
            // RSVD (reserved): default XX
      8'h8D: reg_rgb565 = 16'hC840;
            // RSVD (reserved): default XX
      8'h8E: reg_rgb565 = 16'h7905;
            // RSVD (reserved): default XX
      8'h8F: reg_rgb565 = 16'hC830;
            // RSVD (reserved): default XX
      8'h90: reg_rgb565 = 16'h7926;
            // RSVD (reserved): default XX
            //----
            //x"1500", -- COM10 Use HREF not hSYNC
      8'h91: reg_rgb565 = 16'h1520;
      ...
      8'h9C: reg_rgb565 = 16'h73F1;
            // SCALING_PCLK_DIV (divided by 8)
            // [7:4]=F: Reserved, and manual says default is 0
            //          but Implementation Guide says F
            // [3]=0: Enable clk divider for DSP scale control
            // [2:0]=001: Divided by 2 -> QVGA  
      8'h9D: reg_rgb565 = 16'hA202;
            // SCALING_PCLK_DELAY (default)
            // [7]: Reserved
            // [6:0]=02: Default scaling ouput delay
      8'h9E: reg_rgb565 = 16'hFFFF;
            // FINISH CONDITION
      8'h9F: reg_rgb565 = 16'hFFFF;
            // FINISH CONDITION
      default: reg_rgb565 = 16'hFFFF;
    endcase
  end
